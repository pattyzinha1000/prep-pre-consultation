    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary text-primary-foreground py-2 md:py-3 lg:py-4">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="mt-6 md:mt-8 bg-warning rounded-lg p-4 md:p-6 max-w-4xl mx-auto" style={{border: '2px solid #ffff00'}}>
            <p className="text-large md:text-xl-readable font-semibold text-center text-white">
